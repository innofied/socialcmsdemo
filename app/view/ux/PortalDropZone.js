/**
 * @class Cynergic.view.ux.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link Cynergic.view.ux.PortalPanel}.
 */
Ext.define('testing.view.ux.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        testing.view.ux.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        testing.view.ux.PortalDropZone.superclass.unreg.call(this);
    }
});
